...
import { Search, Save, BookOpen, Tag, Hash, Barcode, CheckCircle, UserCheck } from 'lucide-react';
    ...
    <div className="flex flex-col h-full space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-2">Quét mã vạch (ISBN) để thao tác Mượn / Trả sách cực nhanh</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-indigo-50 rounded-2xl p-6 text-sm text-indigo-800 border border-indigo-100">
            ...
            <ul className="space-y-2 list-disc pl-4 text-indigo-700/80">
              <li>Dùng máy quét mã vạch tít vào mặt sau của sách.</li>
              <li>Bấm nút <strong>Cho mượn (-1)</strong> hoặc <strong>Nhận trả (+1)</strong>.</li>
              <li>Ấn <strong>Cập nhật Sách</strong> để hệ thống tự động bắn sóng vô tuyến cập nhật lên Nhãn giá ở trên kệ!</li>
            </ul>
          </div>
        </div>

        {/* Book Details & Edit Section */}
          ...
          {scannedBook ? (
            ...
            >
              ...
              <div className="p-6 flex gap-6">
                {/* Book Cover */}
                <div className="w-1/3 bg-gray-100 rounded-xl overflow-hidden shadow-sm flex-shrink-0 border border-gray-200">
